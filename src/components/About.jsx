...
const About = ({ hasAnimated }) => {
  const features = [
    ...
    },
    {
      ...
      description: "Creating intuitive interfaces with solid backend logic",
    },
    {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-lg text-gray-700 mb-6">
                ...
                React, JavaScript, and Laravel, focusing on scalable,
              ...
              <p className="text-lg text-gray-700 mb-6">
                ...
                combining pixel-perfect user interfaces with scalable backend
                systems.
              </p>
